          ...
          <div className="titlebar-profile" onClick={() => setDropdownOpen(!dropdownOpen)}>
            ...
            {dropdownOpen && (
              <div className="account-dropdown" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="account-dropdown-item" onMouseDown={(e) => { e.stopPropagation(); onLogin(); setDropdownOpen(false); }} onClick={(e) => e.stopPropagation()} style={{ color: 'var(--accent-color)' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
